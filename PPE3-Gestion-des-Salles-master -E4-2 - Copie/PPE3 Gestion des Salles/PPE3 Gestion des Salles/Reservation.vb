Public Class Reservation
    ...
    Private Sub BoutonReservationValide_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BoutonReservationValide.Click
        ...
        Dim horaire_yeardebut As String = Me.BoxYearDebut.Value
        Dim horaire_monthdebut As String = Me.BoxMonthDebut.Value
        Dim horaire_daydebut As String = Me.BoxDayDebut.Value
        Dim horaire_yearfin As String = Me.BoxYearFin.Value
        Dim horaire_monthfin As String = Me.BoxMonthFin.Value
        Dim horaire_dayfin As String = Me.BoxDayFin.Value()
        ...
        Try
            Dim query As String = "INSERT INTO RESERVATION (ID_SALLE, ID_EMPLOYE, ID_ETAT, DATEDEBUT, LIBELLERESERVATION) VALUES (" & idSalle & ", " & Main.idEmploye & ", 1, TO_DATE('" & horaire_daydebut & "-" & horaire_monthdebut & "-" & horaire_yeardebut & " " & horaire_hour & ":00:00', 'DD-MM-YYYY HH24:MI:SS'),'" & Libelle & "');"
            myCommand.Connection = myConnection
    ...
    Private Sub Calculer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonCalculer.Click
        ...
        If Me.RadioButtonjour.Checked Then

            Me.TableauCalculPeriode.Text = Me.RadioButtonjour.Text()

        End If

        If Me.RadioButtonsemaine.Checked Then

            Me.TableauCalculPeriode.Text = Me.RadioButtonsemaine.Text()

        End If

        If Me.RadioButtonmois.Checked Then

            Me.TableauCalculPeriode.Text = Me.RadioButtonmois.Text()
